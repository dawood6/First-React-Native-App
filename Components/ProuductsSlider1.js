...
export default class ProuductSlider1 extends Component {
  render() {
    return (
      <View>
        <Text style={{ fontSize: 30, color: "#000", marginTop: 80 , color: 'dodgerblue'}}>
          Flash Sale ⚡
         </Text>
        <CountDown
        ...
        <CardSilder>
            <Image
              ...
              source={{uri:   "http://static-01.daraz.pk/original/8b3c21e5d7c0f2f14736126ca70bfd02.jpg"
            }}
            onPress={() => navigation.navigate('SafeHand')}
              />
            <Image
              style={{ height: 270, width: 200, margin: 10, marginLeft: 70 }}
              source={{uri:   "https://static-01.daraz.pk/original/c8a642be3c6ffd3436d770525c23f96d.jpg"
            }}
            onPress={() => navigation.navigate('Westpoint')}
              />
            <Image
              style={{ height: 270, width: 200, margin: 10, marginLeft: 70 }}
              source={{uri:   "http://static-01.daraz.pk/p/a111e6deb9a1a0049d4a307f543d64cd.jpg",
            }}
            onPress={() => navigation.navigate('Green')}
              />
            <Image
              style={{ height: 270, width: 200, margin: 10, marginLeft: 70 }}
              source={{uri:   "https://static-01.daraz.pk/p/4f28e730fef7d78a194fa8295813ef6d.jpg",
            }}
